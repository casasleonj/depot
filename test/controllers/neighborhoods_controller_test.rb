...
class NeighborhoodsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create neighborhood" do
    assert_difference('Neighborhood.count') do
      post neighborhoods_url, params: { neighborhood: {  name_neighborhood: @neighborhood.name_neighborhood = 'maranta', city_id: @neighborhood.city_id = 1} }
    end
  ...
  test "should update neighborhood" do
    patch neighborhood_url(@neighborhood), params: { neighborhood: {  name_neighborhood: @neighborhood.name_neighborhood = 'maranta', city_id: @neighborhood.city_id = 1} }
